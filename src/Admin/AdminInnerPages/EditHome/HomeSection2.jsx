...
import { getHomeSectionSecond, updateHomeSectionSecond, addHomeSectionSecond, deleteHomeSectionSecond  } from '../../AdminServices';
    ...
    <Box>
          ...
          <TableBody>
            {data.map((item,index) => (
              <TableRow key={item.id}>
                ...
                <TableCell>
                  <img src={item.slider_img_path} alt="Slider" style={{ maxWidth: '100px', maxHeight: '100px' }} />
                </TableCell>
                <TableCell>{item.original_name}</TableCell>
                <TableCell>
                  <Button startIcon={<EditIcon />} onClick={() => handleEditClick(item)}>
                    Edit
                  </Button>
                </TableCell>
                <TableCell>
                  <Button startIcon={<DeleteIcon />} onClick={() => handleDeleteClick(item.id)}>
                    Delete
                  </Button>
                </TableCell>
              </TableRow>
      ...
      <Dialog open={openUpdateDialog} onClose={handleCloseUpdateDialog}>
        ...
        <DialogActions>
          ...
          <Button onClick={handleUpdateImage} variant="contained" color="primary">
            Update
          </Button>
        </DialogActions>
      </Dialog>
