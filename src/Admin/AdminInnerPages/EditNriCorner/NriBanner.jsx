...
function NriBanner() {
  ...
  const [formData, setFormData] = useState({ banner_heading: '', banner_img: null, section_one_heading: '', section_one_content: '' });
  ...
  const handleFormSubmit = async () => {
    ...
    try {
      ...
      formDataToSend.append('section_one_heading', formData.section_one_heading);
      formDataToSend.append('section_one_content', formData.section_one_content);
          ...
          <Table>
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell><img style={{ maxWidth: "100px" }} src={nriData.banner_img} alt="Banner Image" /></TableCell>
                <TableCell>{nriData.section_one_heading}</TableCell>
                <TableCell>{nriData.section_one_content}</TableCell>
                <TableCell>
                  <Button startIcon={<EditIcon />} onClick={handleEditClick}>Edit</Button>
                </TableCell>
              </TableRow>
            </TableBody>
          </Table>
