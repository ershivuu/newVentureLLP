...
import "./VenturePolicy.css";
import Headers from "../../components/Headers/Headers";
import Footers from "../../components/Footers/Footers";

function VenturePolicy() {
  return (
    <>
      <Headers />
      <div className="policy-page-heading">
        <p>
          Privacy Policy - <span>Last updated: July 10, 2024</span>
        </p>
      </div>
      ...
      <div className="all-policy">
        <div className="sub-policy-container">
          <div className="policy-name">
            ...
            <p className="policy-sub-name">Interpretation</p>
          </div>
          <div className="policy-desc">
            <p>
        ...
        <div className="sub-policy-container">
          ...
          <div className="policy-desc">
            ...
            <p>
              ...
              in this Agreement) refers to corusview venture LLP, C-06 prteek
              plams Indore (452010).
            </p>
            <p>
        ...
        <div className="sub-policy-container">
          ...
          <div className="policy-desc">
            ...
            <p className="policy-sub-name">
              Website refers to corusview venture LLP, accessible from &nbsp;
              <a href=" https://corusviewventure.com">
                https://corusviewventure.com
              </a>
            </p>
            <p>
        ...
        <div className="sub-policy-container">
          <div className="policy-name">
            ...
            <p className="policy-sub-name">Types of Data Collected</p>
          </div>

          <div className="policy-desc">
            <p className="policy-sub-name">Personal Data</p>
            <p>
            ...
            <p className="policy-sub-name">Email address</p>
            <p className="policy-sub-name">First name and last name</p>
            <p className="policy-sub-name">Phone number</p>
            <p className="policy-sub-name">Usage Data</p>
            <p className="policy-sub-name">
        ...
        <div className="sub-policy-container">
          <div className="policy-name">
            ...
            <p className="policy-sub-name">Necessary / Essential Cookies</p>
            <p className="policy-sub-name">Type: Session Cookies</p>
            <p className="policy-sub-name">Administered by: Us</p>
          </div>
          <div className="policy-desc">
            <p>
        ...
        <div className="sub-policy-container">
          ...
          <div className="policy-desc">
            ...
            <p className="policy-sub-name">
              By email:
              <a href="mailto:contact@corrusviewventure.com">
                contact@corrusviewventure.com
              </a>
            </p>
          </div>
        </div>
